...
our %config = (
  ...
  openssldir => "/Users/jeffmony/sources/AndroidFFmpegCompile/openssl-1.1.1-stable-SNAP-20210524/android/x86_64",
  options => "-D__ANDROID_API__=24 --prefix=/Users/jeffmony/sources/AndroidFFmpegCompile/openssl-1.1.1-stable-SNAP-20210524/android/x86_64 --openssldir=/Users/jeffmony/sources/AndroidFFmpegCompile/openssl-1.1.1-stable-SNAP-20210524/android/x86_64 no-afalgeng no-asan no-buildtest-c++ no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "darwin-thread-multi-2level",
  perl_cmd => "perl",
  perl_version => "5.28.2",
  perlargv => [ "android-x86_64", "-D__ANDROID_API__=24", "no-shared", "no-ssl2", "no-ssl3", "no-comp", "no-hw", "no-engine", "--prefix=/Users/jeffmony/sources/AndroidFFmpegCompile/openssl-1.1.1-stable-SNAP-20210524/android/x86_64", "--openssldir=/Users/jeffmony/sources/AndroidFFmpegCompile/openssl-1.1.1-stable-SNAP-20210524/android/x86_64" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/Users/jeffmony/sources/AndroidFFmpegCompile/openssl-1.1.1-stable-SNAP-20210524/android/x86_64",
  processor => "",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -mandroid --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-24/arch-x86_64",
  ...
  cxxflags => "-std=c++11 -pthread  -mandroid --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-24/arch-x86_64",
  defines => [  ],
